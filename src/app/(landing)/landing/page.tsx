            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="p-6 rounded-2xl bg-danger/5 border border-danger/20 text-center">
                  ...
                  <p className="text-4xl font-black text-danger">47.94</p>
                  <p className="text-xs text-text-secondary mt-1">/mese &middot; 575 /anno</p>
                </div>
                <div className="p-6 rounded-2xl bg-success/5 border border-success/20 text-center relative">
                  ...
                  <p className="text-4xl font-black text-success">15.98</p>
                  <p className="text-xs text-text-secondary mt-1">/mese &middot; 192 /anno</p>
                </div>
                <div className="p-6 rounded-2xl bg-accent/5 border border-accent/20 text-center">
                  ...
                  <p className="text-4xl font-black text-accent-light">383</p>
      ...
      <section className="relative px-4 py-24">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          {session ? (
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-10 py-4 rounded-2xl bg-accent text-white font-semibold text-lg hover:bg-accent-light transition-all hover:shadow-lg hover:shadow-accent/25"
            >
              Vai alla Dashboard
              <ArrowRight size={20} />
            </Link>
